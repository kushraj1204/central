package com.nchl.central.model.entity.metainfo;
...
public abstract class AbstractCorePersistableEntity implements Serializable {
    ...
    @Embedded
    com.nchl.central.model.entity.metainfo.SystemUsername createdBy;

    @LastModifiedBy
    @AttributeOverride(name = "username", column = @Column(name = "lchg_user_id",insertable=false))
    @Embedded
    com.nchl.central.model.entity.metainfo.SystemUsername lastModifiedBy;
